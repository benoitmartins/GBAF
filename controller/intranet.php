...
function pageActor()
{
    ...
    $commentExist = getCommentExist($_GET['id_actor'],$member['id']);
    $voteExist = getVoteExist($_GET['id_actor'],$member['id']);
    ...
    foreach ($votes as $vote) {
        $votesByActor += array($vote['member_id'] => $vote['vote']);
    }
